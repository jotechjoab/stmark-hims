...
<head>
  ...
  <title>St. Marks Surgery   | Clinic Services</title>
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Clinic Services</h3>
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create Service </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT s.id,s.name,s.description,s.created_at,c.name as category FROM services s,pat_categories c WHERE s.category_id=c.id ORDER BY created_at DESC");
        ...
        <div class="modal-dialog" >
          <div class="modal-content" style="width: 900px;">
            ...
            <div class="modal-body" >
               <form method="POST" action="addnewservice.php">
              <div class="row">
                  ...
                  <div class="form-group col-md-12" >
                        <label>Select Services Category</label>
