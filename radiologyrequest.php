...
<head>
  ...
  <title>St. Marks Surgery | Radiology Requests </title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Radiology Requests</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Radiology Requests</h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT p.fname,p.lname,p.mname,v.date_visited,r.status,r.id,(SELECT t.name FROM services t WHERE t.id IN (r.requested_services)) as tests FROM requests r , patient_details p, visits v WHERE (r.patient_id=p.id AND r.visit_id=v.id) AND r.request_type=2");
        ...
        <div class="modal-dialog modal-lg" >
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Upload Radiology Requests Results</h4>
