...
<head>
  ...
  <title>St. Marks Surgery   | Service Categories</title>
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create Service Category</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT * FROM pat_categories  ORDER BY name DESC");
        ...
        <div class="modal-dialog" >
          <div class="modal-content" style="width: 900px;">
            <div class="modal-header">
              <h4 class="modal-title">Create Service Category</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" >
               <form method="POST" action="addnewservicecat.php">
              <div class="row">
