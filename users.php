...
<head>
  ...
  <title>St. Marks Surgery   | Users</title>
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create User </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT * FROM users ORDER BY name ASC");
