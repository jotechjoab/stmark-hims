...
<head>
  ...
  <title>St. Marks Surgery   | vitals List</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">vitals List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">vitals List</h3>
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create vitals </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT * FROM vitals_list ORDER BY name ASC");
        ...
        <div class="modal-dialog modal-lg" >
          <div class="modal-content" >
            <div class="modal-header">
              <h4 class="modal-title">Add New vitals</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" >
               <form method="POST" action="addtovitals_list.php">
              <div class="row">
               
                  <div class="form-group col-md-12" >
                   vital's Name
                    <input type="text" name="name" class="form-control" placeholder="Vital's Name " required="">
                  </div>
                   <div class="form-group col-md-12" >
                   Units 
