...
<head>
  ...
  <title>St. Marks Surgery   | Medication List</title>
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create Medication </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT * FROM medications_list ORDER BY name ASC");
        ...
        <div class="modal-dialog modal-lg" >
          <div class="modal-content" >
            ...
            <div class="modal-body" >
               <form method="POST" action="addnewmedication.php">
              <div class="row">
                  ...
                  <div class="form-group col-md-12" >
                        <label>Units</label>
                  <select class="form-control" style="width: 100%;" name="units" id="units">
                  <option selected disabled>Select Unit</option>
                  <option>Tablet(s)</option>
                  <option>Capsule(s)</option>
                  <option>Vail(s)</option>  
                  <option>mL(s)</option>
