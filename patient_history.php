...
<head>
  ...
  <title>St. Marks Surgery | Patient History</title>
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo $name."'s Visit History" ?></h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <?php 
                  ...
                  $get_resulst=mysqli_query($conn,"SELECT p.fname,p.lname,p.mname,v.date_visited,v.visit_status,v.pay_status,v.id,v.visit_note FROM patient_details p,visits v WHERE v.patient_id=p.id AND p.id='$p_id' ORDER BY v.created_at DESC");
