...
<head>
  ...
  <title>St. Marks Surgery   | Theatre Procedure List</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Theatre Procedure List</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Theatre Procedure List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
           ...
           ?>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Theatre Procedure List</h3>
                <button class="btn btn-primary float-sm-right" data-toggle="modal" data-target="#modal-default">create Proceedure </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              $get_resulst=mysqli_query($conn,"SELECT id,name,description FROM theatre_procedures ORDER BY name DESC");
                  ...
                  if (mysqli_num_rows($get_resulst)>0) {
                    ...
                    echo '<tr><td colspan="4"><div class="alert alert-warning"> No records Found'.mysqli_error($conn).'</div></td></tr>';
                  }
        ...
        <div class="modal-dialog" >
          <div class="modal-content" style="width: 900px;">
            <div class="modal-header">
              <h4 class="modal-title">Create New Procedure</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" >
               <form method="POST" action="addnewproceedure.php">
              <div class="row">
               
                  <div class="form-group col-md-12" >
                   Procedure Name
                    <input type="text" name="name" class="form-control" placeholder="Procedure Name " required="">
                  </div>
                  <div class="form-group col-md-12" >
                    Description
